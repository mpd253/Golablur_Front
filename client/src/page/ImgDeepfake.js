...
function ImgDeepfake(){
    ...
    function deepfake(){
     ...
     axios.post(`${process.env.REACT_APP_LOCAL_URL}file/process/deepfake/one/image`,null, {
        params:{
                source_file_ID: JSON.parse(sessionStorage.getItem('deepfake')).file.file_ID,
        ...
        <World>
            <Edit>
                ...
                <div><b>원본</b></div>
                    ...
                    <img src={`${process.env.REACT_APP_AMAZON_URL}`+JSON.parse(sessionStorage.getItem('deepfake')).file.path} width="350px" height="350px"/>

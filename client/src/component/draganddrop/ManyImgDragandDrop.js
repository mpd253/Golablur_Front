        ...
        onDrop(e) {
          ...
          if(e.dataTransfer.files[0].uid !== undefined ){
            const params = {
              ...
              Key: sessionStorage.getItem("id")+"/" + arrgroup[0].group_ID + "/deepfake/" +  small_id + "."+fileExt
            };
              ...
              .send((err) => {
                if (err) console.log(err)
                 ...
                 //딥페이크 파일 input output 두개의 파일 전송 
                  axios.post(`${process.env.REACT_APP_LOCAL_URL}file/process/deepfake/upload/group/target/image`,null, {
                    params:{
                          group_ID:arrgroup[0].group_ID,
                          target_file_ID:e.dataTransfer.files[0].uid,
                          user_ID: sessionStorage.getItem('id'),
                          file_Extension: "."+fileExt,
                          real_File_Name: e.dataTransfer.files[0].name,
                          path: sessionStorage.getItem("id")+"/" +arrgroup[0].group_ID+ "/deepfake/" +  small_id + "."+fileExt
...
export default ManyImgDragandDrop;
                ...
                success: (auth) => {
                    ...
                    window.Kakao.API.request({
                        ...
                        success:  async (res) => {
                            ...
                            // // 아이디체크
                            await axios.post(`${process.env.REACT_APP_LOCAL_URL}user/social/signup`,null,{
                                params:{
                                    User_ID:res.id,
                            ...
                            await axios.post(`${process.env.REACT_APP_LOCAL_URL}user/social/login/duringWork`, null,{
                                params:{
                                User_ID:res.id,
